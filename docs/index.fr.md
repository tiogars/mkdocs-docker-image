...
Ce dépôt a pour but de fournir une image Docker pour MkDocs avec des plugins utiles préinstallés, facilitant ainsi la création et la gestion de documentation technique.
